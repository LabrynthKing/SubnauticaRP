...
- **Configurable Refresh & Update Timers:** Update Timers Are Configurable Along With Force Update Timer (In Case It May Get Stuck)

- **(Funny) Hover Texts:** Image Hover Text On Discord For All Different Types Of Situations (Mostly Unfunny Because I Am Unfunny ;( Lol)
...
- **Enable Force Refresh:** Enables Or Disables Force Refresh (Recommended To Keep It Enabled Because Sometimes The Presence Can Get Stuck)
- **RPC Update Interval:** Interval To Update RPC Every X Seconds (Default: 5 Seconds) (Recommended: 10 Seconds) [I DO NOT RECOMMENED ANYTING BELOW 5 AS DISCORD CAN RATE LIMIT IT AND IT MIGHT GET STUCK]
- **Force Refresh Timer:** Interval To Force Refresh The Presence (If Applicable) (Default: 60 Seconds)
...
- If You'd Like To Contribute To The Mod Or If You Have Better Pictures For Certain Biomes Or More Fitting Hover Text Then Feel Free To Suggest So On The Notes Tab Or On My Discord
...
- **[AshenShade](https://www.nexusmods.com/profile/AshenShade):** For The Archon & Echelon Mods
